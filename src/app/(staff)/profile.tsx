/**
 * Staff Profile — Spec §6.2
 * Name, email, facility, logout button, app version, consent link.
  ...
  return (
    ...
    >
      ...
      <View style={styles.avatarSection}>
        ...
        <Text style={styles.role}>Healthcare Staff</Text>
      </View>

      {/* Info cards */}
      <View style={[styles.card, Shadows.card]}>
        <ProfileRow label="Email" value="staff@clinic.lk" />
